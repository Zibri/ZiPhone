...
cd ../
rm -rf ZiPhone ziphone-3.5-mac-os-x-cli.zip ziphone-3.5-mac-os-x-cli
mkdir -p ZiPhone
cd ZiPhone
mkdir ZiPhone
cd ../
...
mv ZiPhone ziphone-3.5-mac-os-x-cli
zip -r ziphone-3.5-mac-os-x-cli.zip ziphone-3.5-mac-os-x-cli
rm -rf ziphone-3.5-mac-os-x-cli