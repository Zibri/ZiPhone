...
unsigned char rdmd5[16]= {  0x08,0x2d,0x8a,0x16,0x96,0x30,0x15,0xa1,0x63,39,0xe3,0x28,0xa5,0xa5,0x75,0x76 };
...
void Banner() {
  ...
  cout << "ZiPhone v3.5a by Zibri. https://ziphone.zibri.org" << endl;
